...
<input type="email" name="email" class="rounded border-gray-200 text-gray-900 w-full mb-4"
value="{{ old('email', $member->email) }}">

<div class="flex justify-between items-center mt-4">
    <a href="{{ route('members.index') }}" class="py-2.5 px-5 mr-2 mb-2 text-sm font-medium
    ...
    @isset($btnNewMember)
        <a href="{{ route('members.create') }}" class="py-2.5 px-5 mr-2 mb-2
